...
public class Player : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        //     transform.position = new Vector3(posx, 1.6f, -10f);
        // }
        //transform.Translate(new Vector3(posx, 0, 0) * speed * Time.deltaTime);
        ...
        //     aimTarget.Translate(new Vector3(posx, 0, 0) * speed *2* Time.deltaTime); //translate the aiming gameObject on the court horizontallly
        // }
